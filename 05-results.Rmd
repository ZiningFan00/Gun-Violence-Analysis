...
qmplot(lon,lat,data=data_new,colour="#b30000",zoom=9,size = I(0.9),alpha=.5,maptype = "toner-lite",main = "Gun violence in California in 2013")+
  theme(legend.position="none")
```
...
From the plot of year 2015, we could find that 
